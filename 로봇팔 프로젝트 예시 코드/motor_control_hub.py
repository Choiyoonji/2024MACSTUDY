...
#    0          0       1
        ...
        self.object_coord['medicine'] = Point()
        self.object_coord['umbrella'] = Point()
        self.object_coord['bag'] = Point()
        self.object_coord['case'] = Point()
        self.object_coord['tooth'] = Point()
        self.object_coord['phone'] = Point()
        self.object_coord['handle'] = Point()
        
        self.offset = {}
        
        self.offset['medicine'] = Point()
        self.offset['medicine'].x = 0
        self.offset['medicine'].y = 0
        self.offset['medicine'].z = 0
        self.offset['umbrella'] = Point()
        self.offset['umbrella'].x = 0
        self.offset['umbrella'].y = 0
        self.offset['umbrella'].z = 3
        self.offset['bag'] = Point()
        self.offset['bag'].x = 0
        self.offset['bag'].y = 0
        self.offset['bag'].z = 0
        self.offset['case'] = Point()
        self.offset['case'].x = 0
        self.offset['case'].y = 0
        self.offset['case'].z = 0
        self.offset['tooth'] = Point()
        self.offset['tooth'].x = 0
        self.offset['tooth'].y = 0
        self.offset['tooth'].z = 0
        self.offset['phone'] = Point()
        self.offset['phone'].x = 0
        self.offset['phone'].y = 0
        self.offset['phone'].z = 0
        self.offset['handle'] = Point()
        self.offset['handle'].x = 0
        self.offset['handle'].y = 0
        self.offset['handle'].z = 0 
    ...
    def position_callback(self, data:ObjPoint):
        self.object_coord[data.object_name].x = data.x - self.offset[data.object_name].x
        self.object_coord[data.object_name].y = data.y - self.offset[data.object_name].y
        self.object_coord[data.object_name].z = data.z - self.offset[data.object_name].z 
    ...
    def set_target_position_tool(self, i):
        ...
        if self.door_open:
            ...
            rospy.Rate(0.5).sleep()
            # ############################### 문 확 열기 ######################################
            self.target_position.x -= 21
            self.target_position.y -= 12
            self.set_target_position()
            rospy.Rate(0.3).sleep()
            # ####################### task를 끝내며 초기 위치로 이동 ##############################
            self.gripper_position = 512
